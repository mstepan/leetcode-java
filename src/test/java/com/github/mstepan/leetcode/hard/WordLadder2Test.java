...
import static com.github.mstepan.leetcode.hard.WordLadder2.findLadders;
...
public class WordLadder2Test {
    ...
    void case1() {
        ...
        assertEquals(List.of("hit", "hot", "lot", "log", "cog"), results.get(0));
        assertEquals(List.of("hit", "hot", "dot", "dog", "cog"), results.get(1));
    }
    ...
    @Test
    void case3() {
        List<List<String>> results = findLadders("a", "c", List.of("a", "b", "c"));
    ...
    @Test
    void case4() {
        List<List<String>> results = findLadders("hog", "cog", List.of("cog"));

        assertEquals(1, results.size());
        assertEquals(List.of("hog", "cog"), results.get(0));
    }
