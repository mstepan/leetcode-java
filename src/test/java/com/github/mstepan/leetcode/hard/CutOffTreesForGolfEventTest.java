...
import static com.github.mstepan.leetcode.hard.CutOffTreesForGolfEvent.cutOffTree;
...
public class CutOffTreesForGolfEventTest {
    ...
    @Test
    void case1() {
        assertEquals(6, cutOffTree(fromMatrix(new int[][] {{1, 2, 3}, {0, 0, 4}, {7, 6, 5}})));
    }

    @Test
    void case2() {
        assertEquals(-1, cutOffTree(fromMatrix(new int[][] {{1, 2, 3}, {0, 0, 0}, {7, 6, 5}})));
    }

    @Test
    void case3() {
        assertEquals(6, cutOffTree(fromMatrix(new int[][] {{2, 3, 4}, {0, 0, 5}, {8, 7, 6}})));
    }
